...
public class Lotto5App {
    ...
    public static void main(String[] args) {
        try (Scanner in = new Scanner(new File("C:/temp/lotto5in.txt"));
             PrintStream ps = new PrintStream("C:/temp/lotto5out.txt", StandardCharsets.UTF_8)) {
    ...
    /**
     * Returns true if the number of evens is greater than  to a threshold limit.
     *
     * @param arr
     *            the input array.
     * @param threshold
     *              the upper limit of the constaint.
     * @return
     *         true, if the number of evens i greater

...
public class MobileContactsApp {
    ...
    static int pivot = -1;
    final static Path path = Paths.get("C:/temp/log-mobile.txt");
                ...
                try {
                    ...
                    switch (choice) {
                        ...
                        case 3:
                            ...
                            System.out.println("Επιτυχής Ενυμέρωση");
                            break;
                        case 4:
                            phoneNumber = getPhoneNumber();
    ...
    public static void printMenu() {
        ...
        System.out.println("1. Εισαγωγή Επαφης");
        System.out.println("2. Διαγραφή Επαφης");
...
//        contact[2] = contacts[positionToUpdate][2];
    ...
    public static String[] delete(String phoneNumber) {
        ...
        // Upper line Can be writter with for

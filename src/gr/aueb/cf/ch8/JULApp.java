...
public class JULApp {
    ...
    public static void main(String[] args) {
        try {
            Scanner sc = getFileDescriptor("C:tmp//test-15.txt");
    ...
    public static Scanner getFileDescriptor1(String s) throws FileNotFoundException {
        File fd = new File(s);
        Logger logger = getLogger();
    ...
    //φτιαχνουμε εναν logger που να gραγει σε ενα αρχειο
